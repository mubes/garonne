    ...
    if( pxStaticEventGroup == NULL )
    ...
    else
        {
            ...
            pxEventBits = ( EventGroup_t * )
                          pxStaticEventGroup; /*lint !e740 EventGroup_t and StaticEventGroup_t are guaranteed to have the same size and alignment requirement - checked by configASSERT(). */
        }
        ...
        while( listCURRENT_LIST_LENGTH( pxTasksWaitingForBits ) > ( UBaseType_t ) 0 )
            {
                ...
                configASSERT( pxTasksWaitingForBits->xListEnd.pxNext != ( ListItem_t * ) &
